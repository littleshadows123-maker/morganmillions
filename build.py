  ...
  <div class="claim-body__inner">
    <div class="claim-body__col">
      ...
      <ul class="claim-list">
        ...
        <li>A 5% nominator fee on every placing your foals earn.</li>
  ...
  <div class="wrap-narrow">
    ...
    <div class="reveal" style="margin-top:1.75rem">
      ...
      <ul style="padding-left:1.25rem;line-height:1.9;margin-top:0.75rem">
        <li><strong>Foal nomination:</strong> $500 per foal, every year from weanling through 4YO. Five payments, $2,500 total. <strong>Sept&nbsp;1</strong> deadline for the weanling initial nom; <strong>Jan&nbsp;1</strong> deadline for yearling through 4YO sustaining payments.</li>
        ...
        <li><strong>Guest Pass (Bridge era only):</strong> $500 per foal per event year, for foals whose sire is not on the Open Roster that year. <strong>Jan&nbsp;1</strong> deadline of the event year. Applies only 2027-2030. Foal birth years 2023-2028 eligible.</li>
      </ul>
  ...
  <div class="stallion-hero__main">
    <div class="stallion-hero__grid">
      <div>
        ...
        <h1 class="sh-title">
          <span class="sh-title__caps">Twenty Sires.</span><br><em>One vault.</em>
